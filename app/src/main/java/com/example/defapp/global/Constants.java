package com.example.defapp.global;
...
public class Constants {
    ...
    public static final String INSTAGRAM_COLOR = "#E1306C";
    public static final String SNAPCHAT_COLOR = "#FFFC00";
    public static final String UBER_COLOR = "#000000";
    public static final String YOUTUBE_COLOR = "#FF0000";
    public static final String TWITTER_COLOR = "#1DA1F2";
